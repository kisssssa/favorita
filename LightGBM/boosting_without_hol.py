...
OUTPUT_DIR = Path("outputs_lightgbm_no_oil_holiday")
...
# Убрали dcoilwtico и is_holiday_event
KNOWN_NUM_COLS = [
    "onpromotion",
    "transactions",
    "dayofweek",
...
def load_and_prepare_features(force_rebuild: bool = False):
    ...
    # Эти колонки читаем и готовим, но в FEATURE_COLS не используем
...
def run_lightgbm(train_feat, valid_known, valid_truth, history_prevalid, meta):
    ...
    study = optuna.create_study(
        study_name="favorita_lightgbm_no_oil_holiday",
        direction="minimize",
